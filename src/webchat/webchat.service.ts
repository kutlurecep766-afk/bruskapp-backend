...
export class WebchatService {
  ...
  async generateMultimodalResponse(text: string, imageBase64: string, imageMime: string): Promise<string | null> {
    ...
    const systemContent = baseSystem + '\n\n!!! COK ONEMLI GORSEL ANALIZI TALIMATI - ASAGIDAKILER HER SEYDEN ONCE GELIR !!!\nKullanici bir gorsel gonderdiginde:\n1. Gorselde ne varsa onu TARIF ET. SADECE gorselde gordugunu anlat.\n2. KESINLIKLE gorselle ilgisi olmayan seyler UYDURMA. Gorselde Bruskapp ile ilgili bir sey yoksa Bruskapp\'ten bahsetme.\n3. Ornegin: ayakkabi fotografi goruyorsan "Bu bir ayakkabi. Rengi siyah, spor model..." de. "Bruskapp yonetim paneli" deme.\n4. "Bu konuda bilgim yok", "gorsel analizi yapamiyorum" KESINLIKLE SOYLEME.\n5. Emin degilsen "Bu goruntude ... goruyorum" diyerek acikla.\n6. Urun, logo, menu, fatura, kartvizit vb taniyorsan adini soyle.\n7. KESINLIKLE her gorsele "bu bizim logomuz" deme.\n' + (logoInfo ? '\n' + logoInfo : '') + '\n!!! GORSEL ANALIZI TALIMATI SONU !!!'
